# Проектная работа.
# Построение сетей ЦОД с поддержкой L2 и L3 связности объединенные по схеме Multi-site (IPv6 only).
...
| IP-VRF 1 | Symmetric IRB | CUST-1 | 11111111 | (Router ID):1 | 1000:11111111 |
...
* Межсайтовая схема взаимодействия - Multi-Site;
