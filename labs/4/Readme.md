...
* Адрес для Router ID назначается: x = 1 - для Leaf-коммутаторов и x = 2 - для Spine-коммутаторов; y = 1 - для Spine-коммутаторов и y = [1...4] - для Spine-коммутаторов, а z - назначается по порядку следования для каждого из уровней.
